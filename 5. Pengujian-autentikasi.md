# 🟩 Dokumentasi Testing PPSK + RADIUS  
...
## ✅ 1. Client Connect SSID

<img src="upload/Test%20client%203.jpg" width=500px>

client akses SSID `TEST_OMADA_PPSK`

## ✅ 2. Client Input Kredensial

<img src="upload/Test%20client%202.jpg" width="500px">
...
## ✅ 3. FreeRADIUS — Access Request Diterima

Saat perangkat mencoba koneksi, Omada AP mengirim:

<img src="upload/test-omada-freeradius-log-1.png" width=500px >
...
> ✔ Menandakan Omada mengirim autentikasi MAC + PPSK menuju RADIUS.

---

## ✅ 4. FreeRADIUS — Query ke Database daloRADIUS

<img src="upload/test-omada-freeradius-log-2.png" width=700px>
...
> ✔ Menandakan user ditemukan dan PPSK ditemukan pada radreply.

---

## ✅ 5. FreeRADIUS — Response Access-Accept

<img src="upload/test-omada-freeradius-log-3.png" width=600px >
...
> ✔ Omada menerima PPSK dari RADIUS.

---

## ✅ 6. Hasil Akhir: Perangkat Berhasil Terhubung
...
## ✅ 7. daloRADIUS — Data Accounting

**Path:**  
`Accounting → All Users Accounting`
...
> ✔ Accounting berjalan sukses.

---

# ✅ 8. Status Client Pada Omada Controller

**Path:**  
`Omada Controller → Clients → Online`
...
<img src="upload/test-omada-controller-client-2.png" width=200px >
...
|------------------------|--------|------------|
| AP → FreeRADIUS        | ✔ OK   | Request masuk |
| Query SQL RADIUS       | ✔ OK   | User ditemukan |
| Response RADIUS        | ✔ OK   | Access-Accept terkirim |
| PPSK via RADIUS        | ✔ OK   | Tunnel-Password dikirim |
| Client Connection      | ✔ OK   | IP & koneksi sukses |
| daloRADIUS Accounting  | ✔ OK   | Log masuk |
| Omada Controller       | ✔ OK   | Device muncul sebagai Connected |
